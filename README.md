...
**ShieldVault does not track, collect, or store your typed text, API keys, or browsing history. Period.**

### What we DON'T do:
- We **never** transmit your messages, API keys, or secrets to any server. All detection happens 100% locally in your browser.
